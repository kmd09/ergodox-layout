...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_6,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_TRANSPARENT,KC_LCTL,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_TRANSPARENT,LT(1,KC_NO),KC_GRAVE,KC_BSLASH,KC_LEFT,KC_RIGHT,KC_LCTL,KC_LALT,KC_LCTL,KC_SPACE,KC_ESCAPE,KC_LGUI,KC_5,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,KC_TRANSPARENT,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_QUOTE,KC_TRANSPARENT,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_RSHIFT,KC_DOWN,KC_UP,KC_LBRACKET,KC_RBRACKET,LT(1,KC_NO),KC_LALT,KC_RCTRL,KC_RCTRL,RGUI_T(KC_NO),KC_BSPACE,KC_ENTER),
